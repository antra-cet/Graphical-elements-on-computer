...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0.8, 1)),
            VertexFormat(glm::vec3(5, 0, 5), glm::vec3(0, 1, 1), glm::vec3(0.2, 1, 0.6)),
            VertexFormat(glm::vec3(5, 5, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 5, 5), glm::vec3(0, 1, 1), glm::vec3(1, 0.8, 0.6))
        };
        ...
        meshes["piramida"] = new Mesh("generated piramida lui ian");
        meshes["piramida"]->InitFromData(vertices, indices);

        // Actually create the mesh from the data
        CreateMesh("piramida-ian", vertices, indices);
    }

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(30, 40,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(30, 30,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(40, 30,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(40, 40, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6))
        };
        ...
        meshes["sq"] = new Mesh("generated square");
        meshes["sq"]->InitFromData(vertices, indices);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["piramida-ian"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexNormal"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f, 1, 1));
